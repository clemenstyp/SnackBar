...
class Apipage():
    ...
    def api_info_userid(self, userid):
        try:
            ...
            coffeeDict = get_coffee_dict(curuser, last_purchase, self.get_extra_data(request))
    ...
    def get_extra_data(self, theRequest):
        return_data = {}
    ...
    def api_buy(self):
        ...
        try:
            ...
            coffeeDict = get_coffee_dict(curuser, user_purchase, self.get_extra_data(request))
